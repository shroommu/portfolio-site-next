...
As of 2025, the average American carries [https://www.cnbc.com/select/average-american-debt-by-age/]($63,500 in debt.) I created this project in order to apply data analysis techniques to visualize personal debt by year and state. 
...
I used the [https://www.newyorkfed.org/microeconomics/hhdc](Household Debt and Credit Report) as reported by the Federal Reserve Bank of New York, which tracks debt on a quarterly basis across the following categories: Auto, Credit Card, Mortgage, Student Loan, and Total Debt.
